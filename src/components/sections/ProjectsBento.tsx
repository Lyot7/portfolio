...
// Données par défaut si aucun projet n'est fourni
const defaultCardData: BentoCardProps[] = [
  {
    color: '#060010',
    title: 'Portfolio Personnel',
    description: 'Site web portfolio moderne développé avec Next.js 15, TypeScript et Tailwind CSS',
    label: 'Web'
  },
  {
    color: '#060010',
    title: 'Application E-commerce',
    description: 'Plateforme de vente en ligne complète avec gestion des produits et panier d\'achat',
    label: 'Full-Stack'
  },
  {
    color: '#060010',
    title: 'Dashboard Analytics',
    description: 'Tableau de bord interactif pour visualiser et analyser des données métriques',
    label: 'Data'
  },
  {
    color: '#060010',
  ...
  },
  {
    color: '#060010',
    title: 'API REST',
    description: 'API RESTful robuste avec authentification JWT et validation des données',
    label: 'Backend'
  },
  {
    color: '#060010',
    title: 'Site Vitrine',
    description: 'Site vitrine responsive pour une entreprise locale avec design moderne',
    label: 'Frontend'
  }
];
...
const ProjectsBento: React.FC<BentoProps> = ({
  textAutoHide = true,
  enableStars = true,
  ...
  // Utiliser les projets fournis ou les données par défaut
  const cardData = projects ? projects.map(project => ({
    ...project,
    color: '#060010',
    label: project.technologies[0] || 'Projet'
  })) : defaultCardData;
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(22, 101, 52, 0.4), 0 0 30px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(22, 101, 52, 0.2), 0 0 30px rgba(${glowColor}, 0.2);
          }
                      ...
                      <div className="flex gap-2">
                        {card.githubUrl && (
                          <a 
                            ...
                            className="flex-1 inline-flex items-center justify-center gap-1 h-6 px-2 text-xs font-medium rounded-md border border-green-500/30 bg-transparent text-green-300 hover:bg-green-500/20 hover:border-green-400/50 transition-all duration-200"
                          >
                        ...
                        {card.liveUrl && (
                          <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="flex-1 inline-flex items-center justify-center gap-1 h-6 px-2 text-xs font-medium rounded-md bg-green-600 hover:bg-green-700 text-white transition-all duration-200"
                          >
